...
export function AuthForm({ type, onSubmit, isLoading }: AuthFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <Input
            ...
            className={cn("h-11 rounded-xl pr-11", errors.password && "border-destructive focus-visible:ring-destructive")}
          />
          <button
            type="button"
      ...
      <Button type="submit" variant="default" size="lg" className="w-full bg-white text-black hover:bg-zinc-200" disabled={isLoading}>
      ...
      <div className="relative py-2">
        <div className="absolute inset-0 flex items-center">
          <span className="w-full wm-divider" />
        </div>
        <div className="relative flex justify-center">
          <span className="bg-card px-3 text-overline">Or continue with</span>
        </div>
      </div>
