...
export function AddContentCard({ onClick }: AddContentCardProps) {
  return (
    <div
      onClick={onClick}
      className="cursor-pointer border-2 border-dashed border-ray-600  bg-black rounded-lg p-4 text-white w-full  max-w-xs     mx-auto  hover:border-gray-300  transition-all
      "
    >
