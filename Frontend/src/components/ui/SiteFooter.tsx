...
export function SiteFooter({ className }: SiteFooterProps) {
  ...
  return (
    <footer className={cn("relative mt-8 overflow-hidden border-t border-zinc-800 bg-black text-white", className)}>
      <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-zinc-700/50 to-transparent" aria-hidden />

      {/* Brand watermark */}
      <div className="relative overflow-hidden py-10 sm:py-14 select-none pointer-events-none" aria-hidden>
        <p
          className="font-sans font-bold text-center tracking-[-0.04em] text-[clamp(3.5rem,14vw,11rem)] leading-none opacity-20"
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 pb-10 sm:pb-12 -mt-4 sm:-mt-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pt-8 border-t border-zinc-800/80">
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            >
              <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-white text-black shadow-sm">
                <Brain className="h-5 w-5 text-black" />
              </span>
              <span className="font-sans text-lg font-bold tracking-tight text-white">WebMind</span>
            </button>
          ...
          <div className="lg:col-span-3">
            <h3 className="font-mono text-xs font-medium uppercase tracking-widest text-zinc-500 mb-4">Product</h3>
          ...
          <div className="lg:col-span-4">
            <h3 className="font-mono text-xs font-medium uppercase tracking-widest text-zinc-500 mb-4">Connect</h3>
            <ul className="flex flex-col gap-3">
              <li>
                <a
        ...
        <div className="mt-10 pt-6 border-t border-zinc-800/80 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-zinc-500 text-center sm:text-right">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-zinc-300 hover:text-white font-medium transition-colors underline decoration-zinc-700 underline-offset-4"
            >
              Saeed Saiyed
            </a>
          </p>
